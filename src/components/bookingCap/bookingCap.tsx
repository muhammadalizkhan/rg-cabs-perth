...
// Popular locations within cities
...
export default function BookingCap() {
  ...
  const searchLocations = (query: string, type: string) => {
    ...
    const allLocations = [...australianCities, ...Object.values(popularLocations).flat()]

    const filtered = allLocations.filter((location) => location.toLowerCase().includes(query.toLowerCase())).slice(0, 8)
          ...
          {currentStep === 2 && (
            <div className="space-y-8">
              ...
              <div className="flex justify-between">
                <Button onClick={prevStep} variant="outline" className="px-8 py-3 rounded-xl font-semibold group">
